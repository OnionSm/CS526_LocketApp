...
export default function FeedbackModal({ modalRef, onClose }: { modalRef: any, onClose: () => void }) {
    ...
    const sendIncidentReport = async () => {
        ...
        formData.append('TypeFeedback', "Feedback"); 
    ...
    <BottomSheetModal
      ...
      <BottomSheetView style={styles.container}>
        {/* Tiêu đề */}
        <Text style={styles.header}>Gửi đề xuất</Text>
